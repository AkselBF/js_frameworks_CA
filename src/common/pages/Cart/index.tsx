    ...
    <div className='w-full p-5'>
      ...
      <div className='flex flex-col lg:flex-row sm:justify-between'>
              ...
              <li key={index} className='my-5 flex flex-col sm:flex-row sm:justify-between'>
                <div className='flex flex-row'>
                  ...
                  <div className='mx-5'>
                    ...
                    <p>Discount: {item.discountedPrice}kr</p>
                  </div>
                </div>
        ...
        <div className='bg-[#171717] p-5 text-white rounded-lg lg:w-[50%]'>
          ...
          <h4 className='text-right font-semibold'>Total Price: {totalPrice}kr</h4>
          <div className='relative my-28'>
            {cart.length > 0 ? (
              <Link to={'/checkout'}>
                <button className='absolute bottom-10 right-0 text-white font-semibold bg-blue-700 py-2 w-[180px] rounded-md'>Checkout</button>
              </Link>
            ) : (
